...
struct __attribute__((packed)) thunk<8> {
  ...
  unsigned char movaps_xmm0_rsp_plus_0x20[5] = {0x0F, 0x28, 0x44, 0x24, 0x20};
  unsigned char movaps_rsp_plus_0x8_xmm0[5]  = {0x0F, 0x11, 0x44, 0x24, 0x08};
...
struct __attribute__((packed)) thunk<9> {
  ...
  unsigned char movaps_xmm0_rsp_plus_0x30[5] = {0x0F, 0x28, 0x44, 0x24, 0x30};
  ...
  unsigned char movups_rsp_plus_0x8_xmm0[5]  = {0x0F, 0x11, 0x44, 0x24, 0x08};
